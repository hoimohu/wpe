...
Blockly.ScratchBlocks.VerticalExtensions.registerAll = function () {
    ...
    // 挿入したコード： 追加したカテゴリーの色
    Blockly.Colours["basic"] = {
        "primary": "#FFAB19",
        "secondary": "#EC9C13",
        "tertiary": "#CF8B17"
    };
    Blockly.Colours["meta"] = {
        "primary": "#4C97FF",
        "secondary": "#4280D7",
        "tertiary": "#3373CC"
    };
    Blockly.Colours["structure"] = {
        "primary": "#F78392",
        "secondary": "#F4909D",
        "tertiary": "#F49CA8"
    };
    Blockly.Colours["modifier"] = {
        "primary": "#5CB1D6",
        "secondary": "#47A8D1",
        "tertiary": "#2E8EB8"
    };
    Blockly.Colours["embed"] = {
        "primary": "#CF63CF",
        "secondary": "#C94FC9",
        "tertiary": "#BD42BD"
    };
    Blockly.Colours["table"] = {
        "primary": "#FF8C1A",
        "secondary": "#FF8000",
        "tertiary": "#DB6E00"
    };
    Blockly.Colours["form"] = {
        "primary": "#9966FF",
        "secondary": "#855CD6",
        "tertiary": "#774DCB"
    };
    Blockly.Colours["attributes"] = {
        "primary": "#59C059",
        "secondary": "#46B946",
        "tertiary": "#389438"
    };
    Blockly.Colours["others"] = {
        "primary": "#FF6680",
        "secondary": "#FF4D6A",
        "tertiary": "#FF3355"
    };
    var newCategoryNames = ['basic', 'meta', 'structure', 'modifier', 'embed', 'table', 'form', 'attributes', 'others'];
    for (var i2 = 0; i2 < newCategoryNames.length; i2++) {
        var name2 = newCategoryNames[i2];
        Blockly.Extensions.register('colours_' + name2,
            Blockly.ScratchBlocks.VerticalExtensions.colourHelper(name2));
    }
    // ここまで
